...
import com.itcast.demo.domain.PaymentDto;
import com.itcast.demo.utils.PayUtil;
import com.itcast.demo.utils.UUIDHexGenerator;
import com.itcast.demo.utils.XmlUtil;
...
public class WeiXinPaymentController {
    ...
    private final String notify_url = "http://127.0.0.1/8080/weixin/paycallback.do";//通知地址
    ...
    private final String key ="T6m9iK73b0kn9g5v426MKfHQH7X8rKwb";// "&key=填写商户支付密钥"; // 商户支付密钥
    private final String appid ="wx8397f8696b538317"; //"填写小程序AppId";
